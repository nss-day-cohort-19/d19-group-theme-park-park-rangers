...
function displayModal(dat,id){
    ...
    for (let i = 0; i < types.length; i++) {
        ...
        typeGroup.type = type.name.charAt(0).toUpperCase() + type.name.slice(1) + "s";
        ...
        for (let a = 0; a < dat.length; a++) {
            ...
            if (attraction.type_id === type.id) {
                ...
                if (attraction.area_id === 1){
                	attraction.area_id = "#730217";
                }else if(attraction.area_id === 2){
                	attraction.area_id = "#D15530";
                }else if(attraction.area_id === 3){
                	attraction.area_id = "#A37849";
                }else if(attraction.area_id === 4){
                	attraction.area_id = "#2594D9";
                }else if(attraction.area_id === 5){
                	attraction.area_id = "#E73C81";
                }else if(attraction.area_id === 6){
                	attraction.area_id = "#3E4D8C";
                }else if(attraction.area_id === 7){
                	attraction.area_id = "#F2CF53";
                }
                let combinedData = {
                    id: attraction.id,
